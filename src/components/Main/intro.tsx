...
export function Intro() {
	return (
		<article className="flex flex-col gap-4 md:p-[10.5rem] px-12 py-32 bg-blend-overlay bg-cover bg-no-repeat bg-left bg-[url('/images/telhado2-1.jpg')] bg-stone-800 w-full">
