export function About() {
	return (
		<article
			className="flex flex-col items-center gap-4 bg-neutral-100 p-20 w-full text-black text-center"
			id="about"
		>
			...
			<p className="md:w-1/2 w-full">
				...
				prezar pela honestidade e competência. Para isso contamos com uma equipe
				qualificada e bem treinada para o trabalho.
			</p>
		</article>
	);
}
